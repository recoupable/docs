...
Pick the scenario that matches what your human is doing **before** you authenticate. The choice determines whether you can persist artist data across sessions.
