...
**Always ask the human first** unless context makes the choice obvious. Agents are unreliable at guessing intent, and choosing wrong silently costs the user their work — they re-prompt later and find their roster missing.

Use this as your default opener (paraphrase as appropriate to context):

> "Quick question before we start — are you just exploring Recoup, or do you want me to use your Recoup account so this work persists? If you have an account, share your email and I'll send a verification code. Otherwise I can spin up a temporary one for one-shot use."
