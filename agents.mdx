...
| "I have an account, here's my email" — they want to add a new artist | Sign in with their real email | Run the [`create-artist`](https://github.com/recoupable/skills/tree/main/skills/create-artist) skill |
