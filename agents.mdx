...
| "I have an account, here's my email" — they want to add a new artist | Sign in with their real email | Run the [`create-artist`](/skills/create-artist) skill |
| "I don't have an account but I want to set one up" | Sign in with their real email | After auth, run the [`create-artist`](/skills/create-artist) skill to start their roster |
