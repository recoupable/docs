...
<CardGroup cols={3}>
  <Card
    ...
    href="/quickstart"
  >
    Standard HTTP endpoints. Pass your API key in `x-api-key` and call any of the 130+ endpoints.
  </Card>
  <Card
    title="MCP Server"
    icon="cpu"
...
<CardGroup cols={2}>
  ...
  >
    11 endpoints — 7 creative primitives (generate images, videos, captions; transcribe audio; edit, upscale, analyze video) plus full-pipeline create, cost estimation, validation, and template browsing.
  </Card>
  <Card
    title="Automation"
    icon="repeat"
