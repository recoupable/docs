...
2. Install **recoupable-skills** (and any of the four music-industry plugins you want: `recoup-research-plugin`, `recoup-content-plugin`, `recoup-platform-plugin`, `recoup-catalog-deals`).
3. Ask Claude:
