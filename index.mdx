...
<Note>
**Setting up Recoup in Claude Code?** Run these two commands inside Claude Code:
...
It will issue an API key, save it locally, and seed memory so Claude knows to use Recoup whenever you ask about streaming data, campaigns, artists, releases, or syncing documents.
</Note>
