...
<Note>
**Building an AI agent that acts on your behalf?** See [Agent onboarding](/agents) instead. It covers the throwaway-vs-account decision, the roster, and the persistent filesystem. This page assumes you're trying the API yourself.
</Note>
