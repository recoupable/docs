...
<Note>
**Are you an AI agent reading this?** Switch to [Agent onboarding](/agents). It's written for you, with the throwaway-vs-account decision and the roster check. This page assumes you're a developer trying the API.
</Note>
