...
| Generate Video | [POST /api/content/video](/api-reference/content/generate-video) | Create a video. Six modes: prompt, animate, reference, extend, first-last, lipsync. |
...
3. Enable Event Subscriptions → set request URL to `https://api.recoupable.com/api/content-agent/slack`
