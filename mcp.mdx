---
title: "MCP Server"
description: "Connect any AI agent to Recoup via the Model Context Protocol. Claude, ChatGPT, Cursor, and the full Recoup tool catalog natively."
---
...
Tools are organized by domain. Every tool returns structured JSON suitable for chaining into multi-step agent workflows.
