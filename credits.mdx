...
| | **Free** | **Starter** | **Pro** |
|---|---|---|---|
| **Price** | $0 | $19/mo | $99/mo, 30-day trial |
| **Monthly credits** | $3.33 | $20 | $300 |
| **Scheduled tasks** | 1 | 3 | Unlimited |
| **Shortest cadence** | Weekly (10080 min) | Daily (1440 min) | Hourly (60 min) |
| **`plan` value** | `free` | `starter` | `pro` |
